...
// Hypothetical IPL 2025 Schedule Data for May
...
const upcomingMatches = [
  ...
  // Note: Playoff matches (Qualifiers, Eliminator, Final) are excluded as they don't fit the two-team card format easily
];
        ...
        <section>
          <h2 className="text-xl font-semibold mb-1">Upcoming Matches (Hypothetical IPL 2025 - May)</h2>
           <p className="text-sm text-muted-foreground mb-4">
            Note: Official IPL 2025 schedule not released. Data is illustrative based on user input. Playoffs excluded.
          </p>
